            ...
            <div class="row mt-n2 mb-3 mb-sm-0">
              <div class="col col-sm-auto order-1 d-block d-lg-none">
                <button
                  type="button"
                  class="
                    btn btn-soft-success btn-icon btn-sm
                    fs-16
                    email-menu-btn
                  "
                >
          ...
          >
            <ul class="message-list">
              ...
              <li class="unread">
                ...
                <div class="col-mail col-mail-2">
                  <a href="javascript: void(0);" class="subject"
                    ><span class="bg-warning badge me-2">Freelance</span>Since
                    you asked... and i'm inconceivably bored at the train
                    station –
                    <span class="teaser"
                      >Alright thanks. I'll have to re-book that somehow, i'll
              ...
              <li>
                ...
                <div class="col-mail col-mail-2">
                  <a href="javascript: void(0);" class="subject"
                    ><span class="bg-info badge me-2">Support</span>Off on
                    Thursday -
                    <span class="teaser"
              ...
              <li>
                ...
                <div class="col-mail col-mail-2">
                  <a href="javascript: void(0);" class="subject"
                    ><span class="bg-primary badge me-2">Social</span>This
                    Week's Top Stories –
                    <span class="teaser"
              ...
              <li>
                <div class="col-mail col-mail-1">
                  ...
                  <button
                    type="button"
                    class="btn avatar-xs p-0 favourite-btn active fs-15"
                  >
                    <i class="ri-star-fill"></i>
                  </button>
                  <a href="javascript: void(0);" class="title"
              ...
              <li class="unread">
                ...
                <div class="col-mail col-mail-2">
                  <a href="javascript: void(0);" class="subject"
                    ><span class="bg-success badge me-2">Family</span>Last pic
                    over my village –
                    <span class="teaser"
                ...
                <div class="col-mail col-mail-2">
                  <a href="javascript: void(0);" class="subject"
                    ...
                    <span class="teaser"
                      ...
                      inbox. For your records, here is a copy of the information
                ...
                <div class="col-mail col-mail-2">
                  <a href="javascript: void(0);" class="subject"
                    ...
                    <span class="teaser"
                      ...
                      tour 2014", ett rekryteringsevent som erbjuder jobb på 16
              ...
              <li>
                ...
                <div class="col-mail col-mail-2">
                  <a href="javascript: void(0);" class="subject"
                    ...
                    <span class="teaser"
                      >That's great, see you on Thursday!</span
                    >
                  </a>
              ...
              <li>
                ...
                <div class="col-mail col-mail-2">
                  <a href="javascript: void(0);" class="subject"
                    ><span class="bg-primary badge me-2">Social</span>Task
              ...
              <li class="unread">
                ...
                <div class="col-mail col-mail-2">
                  <a href="javascript: void(0);" class="subject"
                    ><span class="bg-info badge me-2">Support</span>Home again!
                    –
                    <span class="teaser"
              ...
              <div class="col">
                <div class="">
                  <button
                    type="button"
                    class="
                      btn btn-soft-danger btn-icon btn-sm
                      fs-16
                      close-btn-email
                    "
                  >
              ...
              <div class="col-auto">
                ...
                >
                  <button
                    type="button"
                    class="
                      btn btn-ghost-secondary btn-icon btn-sm
                      fs-16
                      favourite-btn
                      active
                    "
